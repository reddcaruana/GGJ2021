...
namespace Assets.Scripts.Ui.Screens
{
	public class MainMenuScreen : RDSimpleScreenBase
	{
		...
		protected override void Awake()
		{
			...
			bgBlackImage = transform.Find("ImageBgBlack").gameObject.GetComponent<Image>();
			bgWaterImage = transform.Find("ImageBgWater").gameObject.GetComponent<Image>();
		...
		public override bool Show(Action onComplete = null)
		{
			...
			helperTitle.RectTransform.DOScale(1, helperTitle.DurationHide);
